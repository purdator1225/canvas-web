...
function ContactUs(props) {
  ...
  return (
    <div>
      <div className="relative min-h-[800px] px-6 py-[100px]  text-white">
        <Image
        ...
        />
        <div className="m-auto mb-6 max-w-screen-xl">
          <GsapSplitTextWord>
            <h3
        ...
        <div className="m-auto w-full justify-between sm:flex sm:gap-[100px] xl:w-[1280px]">
          <div
            id="contact-left"
            className="left-side mb-10 flex flex-col justify-between gap-10 sm:basis-1/2"
          >
            <h2 className="text-xl uppercase">Malaysia</h2>
            ...
            <div className="flex flex-wrap justify-start gap-12 ">
              ...
              <div className="flex flex-col gap-6">
                <div className=" flex flex-col gap-2 font-robo text-[18px]  leading-6">
                  <h3 className={`${roboto.variable} `}>Jackson Lim</h3>
          ...
          <div
            id="contact-right"
            className="right-side mb-10 border-t-[1px] py-5 sm:basis-1/2 sm:border-l-[2px] sm:border-t-[0px] sm:px-10 sm:py-0"
          >
            <div className="flex flex-col gap-10">
              <h2 className="text-xl">THAILAND</h2>
              <div className=" flex flex-col gap-2 font-robo text-[18px]  leading-6">
                <h3 className={`${roboto.variable} `}>
                  Supalerk Ployangunsri (Bon)
                </h3>

                <Link rel="noopener noreferrer" href="tel:+6011-1662 6228">
                  +66 63-173-8035 (WHATSAPP)
                </Link>
              ...
              <div>
                ...
                <div>
                  Sathorn Prime Building, <br />
                  16 Floor, Room 1602B, <br />
                  Naradhiwas Rajanagarindra Rd., <br />
                  Yannawa, Sathorn, <br />
                  Bangkok 10120 <br /> Post box: 068
                </div>
              </div>
            </div>
          </div>
      ...
      >
        ...
        {formState === "loading" ? (
          ...
          <div className="bg-red-500 p-2">
            Sorry, your message was not sent. Please try again or contact us at:{" "}
            <br />
            +6011-1116 1106
          </div>
        ) : formState === "success" ? (
