...
function Tnc(props) {
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to BrandCell Studio, 63, LORONG MACALISTER.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Canvas Global, accessible from{" "}
            <a
              href="https://canvasglobal-log.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://canvasglobal-log.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: cglbiz@canvasglobal-log.com</li>
      </ul>
    </div>
  );
}
