...
function Privacy(props) {
  return (
    <div className={`${national.variable} font-national bg-canvasblue p-7 pt-[100px] text-white flex flex-col gap-4`}>
      <h1 className="text-2xl">Privacy Policy of Canvas Global Sdn Bhd </h1>

      <p>
        Canvas Global Sdn Bhd operates the https://canvasglobal-log.com/
      ...
      <p>
        ...
        decided to use our Service, the https://canvasglobal-log.com/ website.
      </p>
      ...
      <p>
        ...
        https://canvasglobal-log.com/, unless otherwise defined in this Privacy
        Policy.
      </p>
